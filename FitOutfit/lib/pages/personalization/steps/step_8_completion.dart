...
class Step8Completion extends StatelessWidget {
  ...
  Widget _buildResponsiveStatsGrid(
    ...
    final stats = [
      ...
      {
        'label': '📸 Photo',
        'value': data.uploadedPhoto != null ? 'Uploaded ✓' : 'Not Uploaded',
        'icon': Icons.photo_camera_rounded,
        'color': data.uploadedPhoto != null ? mintGreen : accentYellow,
        'description': 'Visual style analysis',
      },
      {
        'label': '👗 Body Shape',
  ...
  String _calculateCompletionPercentage() {
    ...
    if (data.selectedGender != null && data.selectedGender!.isNotEmpty)
      completed++;
    if (data.uploadedPhoto != null) completed++;
          ...
          [
            ...
            _buildDetailItem(
              ...
              data.uploadedPhoto != null
                  ? '✨ Successfully uploaded & analyzed'
                  : '⏳ Awaiting upload for better recommendations',
              '🎨 Enables visual style analysis and color matching',
